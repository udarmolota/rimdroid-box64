...
GOM(vkBeginCommandBuffer, iFEpp)
GO(vkBindBufferMemory, iFpppU)
GO(vkBindImageMemory, iFpppU)
GO(vkCmdBeginQuery, vFppuu)
GOM(vkCmdBeginRenderPass, vFEppu)
GOM(vkCmdBindDescriptorSets, vFEpupuupup)
...
GOM(vkDeviceWaitIdle, iFEp)
GOM(vkEndCommandBuffer, iFEp)
...
GOM(vkGetDeviceQueue, vFEpuup)
GO(vkGetEventStatus, iFpp)
GOM(vkGetFenceStatus, iFEpp)
...
GOM(vkQueueSubmit, iFEpupp)
GOM(vkQueueWaitIdle, iFEp)
GOM(vkResetCommandBuffer, iFEpu)
GO(vkResetCommandPool, iFppu)
GO(vkResetDescriptorPool, iFppu)
GO(vkResetEvent, iFpp)
GOM(vkResetFences, iFEpup)
GO(vkSetEvent, iFpp)
GO(vkUnmapMemory, vFpp)
GO(vkUpdateDescriptorSets, vFpupup)
GOM(vkWaitForFences, iFEpupuU)
...
// VK_VERSION_1_3
GOM(vkCmdBeginRendering, vFEpp)
GOM(vkCmdEndRendering, vFEp)
...
GOM(vkAcquireNextImage2KHR, iFEppp)
...
GOM(vkGetSwapchainImagesKHR, iFEpppp)
